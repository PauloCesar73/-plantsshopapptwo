...
import 'package:plantshopapp/src/view/detail_page.dart';
import 'package:plantshopapp/src/view/widgets/plant_widget.dart';


final controle = GetIt.instance.get<Plantsplanta>();
                  ...
                  return Padding(
                    ...
                    child: Observer(builder: (_) {
                      return GestureDetector(
                        onTap: () {
                          controle.selectedIndex = index;
                        },
                        child: Text(
                          plantTypes[index],
                          style: TextStyle(
                            fontSize: 16.0,
                            fontWeight: controle.selectedIndex == index
                                ? FontWeight.bold
                                : FontWeight.w300,
                            color: controle.selectedIndex == index
